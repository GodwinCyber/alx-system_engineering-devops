...
<p><img src="WIxXad8.png" alt="" loading='lazy' style="" /></p>
...
<p>At the end of this project, you are expected to be able to <a href="/rltoken/uDfkZ_HQ_YnelvPnhnBOnw" title="explain to anyone" target="_blank">explain to anyone</a>, <strong>without the help of Google</strong>:</p>
